...
, rbfOrder, polyOrder, stencilSize ) :
    ...
    u1 = un1 - 2.*dt * Cp * th0[ind.m] * ( dpidx + dpids*dsdx )
    w1 = wn1 - 2.*dt * ( Cp * th0[ind.m] * dpids*dsdz + g )
    th1 = thn1
    pi1 = pin1 - 2.*dt * Rd/Cv*pi0[ind.m] * ( dudx+duds*dsdx + dwds*dsdz )
