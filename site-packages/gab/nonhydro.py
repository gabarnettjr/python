...
#get unit tangent and normal vectors on bottom boundary (no ghost nodes):

def getTanNorm( nCol, zSurfPrime, x ) :
...
#Apply a differntial operator (first derivative or HV) laterally:
