...
#     # https://www.overleaf.com/read/vnwkzwyfctxw
...
#     dx1dy =  XC / R
#     ii = X1!=0.
#     dx1dx[ii] = ( -YC[ii]*(XC[ii]*Y[ii]-YC[ii]*X[ii]) - X1[ii]**2.*X[ii] ) / ( X1[ii]*R[ii]**2. )
#     dx1dy[ii] = (  XC[ii]*(XC[ii]*Y[ii]-YC[ii]*X[ii]) - X1[ii]**2.*Y[ii] ) / ( X1[ii]*R[ii]**2. )
...
#     dx2dy = ( 2*Y - YC ) / R
#     ii = X2!=0
#     dx2dx[ii] = ( (R[ii]**2.-XC[ii]*X[ii]-YC[ii]*Y[ii])*(2*X[ii]-XC[ii]) - X2[ii]**2.*X[ii] ) \
#     / ( X2[ii]*R[ii]**2. )
#     dx2dy[ii] = ( (R[ii]**2.-XC[ii]*X[ii]-YC[ii]*Y[ii])*(2*Y[ii]-YC[ii]) - X2[ii]**2.*Y[ii] ) \
#     / ( X2[ii]*R[ii]**2. )
