...
def parseInput() :
    ...
    parser.add_argument("--pta", help="random node perturbation percentage \
...
, dynamicColorbar, noInterp ) :
    ...
    if noInterp :
        ...
        # ell = np.int( np.round( np.shape(tmp)[1] / 32. ) )
        # plt.contourf( xx0[:,:ell], yy0[:,:ell], tmp[:,:ell], cvec )
