...
def parseInput() :
    ...
    + "Note: This is also the time between array-saves, " \
    + "and the time between contour-saves."
    ...
    parser.add_argument("--rhv", help="if 1, use radial hyperviscosity (HV), else do not" \
    , type=np.int64,   default=1)
    
    parser.add_argument("--ahv", help="if 1, use angular hyperviscosity (HV), else do not" \
    , type=np.int64,   default=1)
    
    parser.add_argument("--afd", help="use this if you want conventional" \
