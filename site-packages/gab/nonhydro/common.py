...
def domainParameters(testCase, refinementLevel, g, Cp, th0):
    ...
    if testCase == "risingBubble":
        ...
        top     = 15000.
        dx      = 1000. / 2.**refinementLevel
        nLev    = 15 * 2**refinementLevel
        dt      = 1./1. / 2**refinementLevel
        tf      = 3000.
        saveDel = 250.

        def zSurf(x):                       #use for steady-state test case
            a = 25000.
            h0 = 3000.
        ...
        # def zSurf(x):                   #use for non steady-state test case
        #     h0 = 250.
        #     a = 5000.
        #     lam = 4000.
...
def hydrostaticProfiles(testCase, th0, g, Cp, N):
    ...
    or (testCase == "steadyState") or (testCase == "scharMountainWaves"):
