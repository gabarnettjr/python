...
def constants(testCase):
    ...
    if (testCase == "tortureTest") or (testCase == "scharMountainWaves"):
        th0 = 288.
    else:
...
def domainParameters(testCase, hydrostatic, refinementLevel, g, Cp, th0):
    ...
    if testCase == "risingBubble":
        ...
        left    = -75000. * 267.
        right   = 75000. * 267.
        dx      = 1000. / 2.**refinementLevel * 267.
        bottom  = 0.
        top     = 20000.
        nLev    = 20 * 2**refinementLevel
        if hydrostatic:
            dt      = 50./1. / 2**refinementLevel
            tf      = 50000.
            saveDel = 5000.
        else:
...
def hydrostaticProfiles(testCase, th0, g, Cp, N):
    """
    ...
    or (testCase == "tortureTest") or (testCase == "scharMountainWaves"):
