...
, dsdx, dsdz, rhoBar, Tbar, drhoBarDz, dTbarDz ) :
    ...
    V[0,:,:] = -1/rhoBar * ( Dx(P[i0:i1,:]) + Ds(P[:,j0:j1])*dsdx ) \
    + HVx(U[0,i0:i1,:]) + HVs(U[0,:,j0:j1])
    
    V[1,:,:] = -1/rhoBar * ( Ds(P[:,j0:j1])*dsdz ) \
    - g/rhoBar * U[3,i0:i1,j0:j1]
...
, dsdx, dsdz, rhoBar ) :
    ...
    + U[3,i0:i1,j0:j1] / rhoBar / (rhoBar+U[3,i0:i1,j0:j1]) \
    * ( Dx(P[i0:i1,:]) + Ds(P[:,j0:j1])*dsdx )
    
    V[1,:,:] = -U[0,i0:i1,j0:j1]*Dx(U[1,i0:i1,:]) - sDot*Ds(U[1,:,j0:j1]) \
    + U[3,i0:i1,j0:j1] / rhoBar / (rhoBar+U[3,i0:i1,j0:j1]) \
    * ( Ds(P[:,j0:j1])*dsdz + U[3,i0:i1,j0:j1]*g )
