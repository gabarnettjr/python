...
, Po, g, Rd, Cv, Cp, zBot, zTop, x, z, VL ) :
    ...
    NxBot = - ( wIbot.dot(U[4,0:stc,:]) @ Wa ) / tmp
    NzBot = g / tmp
    ...
    NxTop = - ( wItop.dot(U[4,-1:-stc-1:-1,:]) @ Wa ) / tmp
    NzTop = g / tmp
    ...
    dPdb = wHtop.dot(P[-2:-stc-2:-1,:]) @ Wa
    dphidb = wItop.dot(U[4,-1:-stc-1:-1,:]) @ Wa
