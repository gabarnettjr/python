...
, dsdx, dsdz, thetaBar, piBar, dthetaBarDz ) :
    ...
    V[0,:,:] = -Cp*thetaBar * ( Dx(U[3,i0:i1,:]) + dpids*dsdx ) \
...
, dsdx, dsdz ) :
    ...
    -Cp*U[2,i0:i1,j0:j1] * ( Dx(U[3,i0:i1,:]) + dpids*dsdx )
    
    V[1,:,:] = -u*Dx(U[1,i0:i1,:]) - sDot*dwds \
    -Cp*U[2,i0:i1,j0:j1] * ( dpids*dsdz )
    
    V[2,:,:] = -u*Dx(U[2,i0:i1,:]) - sDot*Ds(U[2,:,j0:j1])
    
    V[3,:,:] = -u*Dx(U[3,i0:i1,:]) - sDot*dpids \
    -Rd/Cv*U[3,i0:i1,j0:j1] * ( dudx+duds*dsdx + dwds*dsdz )
